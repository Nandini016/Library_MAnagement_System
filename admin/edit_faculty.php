<?php
	...
	$query = "select * from faculty where fac_id = $_GET[fid]";
			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="fac_id" value="<?php echo $fac_id; ?>" required>
					</div>
					<div class="form-group">
					...
					<button type="submit" name="update_faculty" class="btn btn-primary">Edit Faculty</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
