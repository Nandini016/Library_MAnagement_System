			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						<label for="stu_id">Roll Number:</label>
						<input type="text" class="form-control" name="stu_id" value="<?php echo $stu_id; ?>" required>
					</div>
					<div class="form-group">
					...
					<button type="submit" name="update_stu" class="btn btn-primary">Edit Student</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
